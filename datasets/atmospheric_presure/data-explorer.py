...
DS_PATH = 'C:\\Users\\60048007\\Documents\\Projects\\ds\\data-explorer\\datasets\\atmospheric_presure\\'
DS_FILE_IN = 'presion-atmosferica-promedio-2019-9.csv'
DS_FILE_OUT_1 = 'atmospheric_presure-eda-ds.js'
DS_FILE_OUT_2 = 'atmospheric_presure-eda-df.js'
DS_SEP = ','
DS_HEADER_ROW = 0
DS_NAME = 'Bs. As. atmospheric_presure'
DS_DESCRIPTION = 'Mediciones promedio de presión atmosférica registradas durante el mes de Septiembre 2019 en la Ciudad de Buenos Aires, Argentina.<sup><a href=\'https://data.buenosaires.gob.ar/dataset/presion-atmosferica/archivo/juqdkmgo-230A-resource\' target=\'_blank\' title=\'View dataset definition\'>1</a>'
DS_COL_DESCRIPTION = ['identificador único de la medición',
                      'fecha y hora de la medición',
                      'valor de la medición',
                      'unidad de medida de la medición',
                      'nombre del lugar donde se encuentra el sensor ',
                      'latitud del sensor',
                      'longitud del sensor',
                      'nombre de la variable de medición',
                      'mes de la medición'
                      ]
DS_COL_SUBTYPES_2 = ['ID', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A']
...
def set_col_values():
    ...
    for col in df.columns:
        ...
        if col != 'observacion' and col != 'timestamp':
